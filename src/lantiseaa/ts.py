...
class TokenLenDistTransformer(BaseDatasetIndependentTSTransformer):
    """ An implementaion of token length distribution time series mapping method

    name : str, default='tokenlendist'
        Name (in short) of the time series mapping method, also used as the name of the 
        column storing time series values in the time series dataframe output from the 
        transform method.
    ...
    def __init__(self, name="tokenlendist", max_length=14, split_function=word_tokenize):
        self.name = name
...
class TokenRankDistTransformer(BaseDatasetDependentTSTransformer):
    """ An implementaion of token rank distribution time series mapping method

    Parameters
    ----------
    name : str, default='tokenrankdist'
        Name (in short) of the time series mapping method, also used as the name of the 
        column storing time series values in the time series dataframe output from the 
        transform method.
    ...
    def __init__(self, name="tokenrankdist", length=1000):
        self.name = name
        self.length = 1000
        # constent variables
    ...
    def transform(self, X):
        """ Map text samples into token rank distribution time series
